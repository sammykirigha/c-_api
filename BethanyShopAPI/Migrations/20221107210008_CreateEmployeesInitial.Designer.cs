...
namespace BethanyShopAPI.Migrations
{
    ...
    [Migration("20221107210008_CreateEmployeesInitial")]
    partial class CreateEmployeesInitial
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BethanyShopAPI.models.Employee", b =>
                {
            ...
            modelBuilder.Entity("BethanyShopAPI.models.Employee", b =>
                {
                    b.HasOne("BethanyShopAPI.models.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BethanyShopAPI.models.JobCategory", "JobCategoryName")
                        .WithMany()
